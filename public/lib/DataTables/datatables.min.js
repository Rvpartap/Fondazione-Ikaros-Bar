...
/*! DataTables 1.13.1
 * б╘2008-2022 SpryMedia Ltd - datatables.net/license
 */
!function(n) {
    "use strict";
    ...
    var p, e, t, C = function(t, v) {
        ...
        y = null,
        this
    }, c = {}, U = /[\r\n\u2028]/g, V = /<.*?>/g, X = /^\d{2,4}[\.\/\-]\d{1,2}[\.\/\-]\d{1,2}([T ]{1}\d{1,2}[:\.]\d{2}([\.:]\d{2})?)?$/, J = new RegExp("(\\" + ["/", ".", "*", "+", "?", "|", "(", ")", "[", "]", "{", "}", "\\", "$", "^", "-"].join("|\\") + ")","g"), q = /['\u00A0,$бёБ┌╛б╔%\u2009\u202F\u20BD\u20a9\u20BArfkи┐н·]/gi, h = function(t) {
        return !t || !0 === t || "-" === t
    }, G = function(t, e) {
    ...
    function Me(t, e, n, a) {
        return 0 === t || t && "-" !== t ? +(t = (t = e ? G(t, e) : t).replace && (n && (t = t.replace(n, "")),
        a) ? t.replace(a, "") : t) : -1 / 0
    }
    function ke(n) {
        P.each({
 ...
 * б╘2018 SpryMedia Ltd - datatables.net/license
 */
!function(t) {
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net"], function(e) {
        ...
        return e = e || window,
        (n = n || ("undefined" != typeof window ? require("jquery") : require("jquery")(e))).fn.dataTable || require("datatables.net")(e, n),
        t(n, 0, e.document)
    }
