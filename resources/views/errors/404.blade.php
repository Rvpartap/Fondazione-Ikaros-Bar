...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	<head>
		...
		<title>Error 404 Page - Fondazione Ikaros Bar</title>
      ...
      <link rel="preconnect" href="https://fonts.googleapis.com" />
		...
		<link rel="stylesheet" type="text/css" href="{{ url("/css/404_style.css") }}" />
   </head>
   <body class="container">
		...
		<div id="home-nav" class="home-navigation">
         ...
         @endif
   		...
   		<a href="https://www.istitutopolitecnico.org/" class="text-nav-fav"><img src="/images/Site-Favicons/favicon-istitutopolitecnico.png" draggable="false" alt="IstitutoPolitecnicoLogo" class="img-favicon2"> Istituto Politecnico</a>
			...
			<hr>
			<a href="/home" target="_blank" style="font-size: 14px; color: #0088ff; width: 310px; margin-bottom: 12px;"><i class="fa-solid fa-gavel fa-lg"></i>&#160; Area riservata per gli Amministratori</a>
		</div>
		<img src="/images/svg/layered-peaks-table-up.svg" class="table-img" alt="table-up">
		<div class="main p-1">
			<h1 class="my-4 error-text"><strong>Errore:</strong></h1>
			<!-- Thank you Genaro Colusso <3 for this SVG creation -->
			...
			<div>
				<h5 class="lost-text mt-3 mb-2">Hey, ti sei perso? Succede, <img src="https://em-content.zobj.net/source/microsoft-teams/337/face-with-hand-over-mouth_1f92d.png" alt="hihihi" style="width: 30px; margin-bottom: 10px; pointer-events: none;"> clicca su:</h5>
				<center><button type="button" class="btn btn-outline-dark mb-2 btn-font" onclick="location.href='/'"><i class="fa-solid fa-arrow-left fa-beat" style="--fa-animation-duration: 3s;"></i>&#160; Torna alla Pagina Home</button></center>
			</div>
			<a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/404" type="button" class="btn btn-light mb-4" target="_blank">Cos'&#232; l'errore 404?</a>
		</div>
		<div class="container-sm">
   		...
   		<div class="border-top d-flex flex-wrap justify-content-between">
   			<p class="text-left pt-3" style="margin-bottom: 16px;"><img src="https://em-content.zobj.net/source/microsoft-teams/337/eyes_1f440.png" alt="privacy" style="width: 30px; margin-bottom: 16px; pointer-events: none;">&#160; Dai un'occhiata alla pagina <a href="https://www.fondazioneikaros.org/privacy-e-cookie-policy/" target="_blank" class="link-decoration"><u>Privacy e Cookie Policy </u></a></p>
   			<p class="text-right pt-3 mb-3"><img src="https://em-content.zobj.net/source/microsoft-teams/337/man-technologist_1f468-200d-1f4bb.png" alt="developer" style="width: 30px; margin-bottom: 16px; pointer-events: none;">&#160; Progettato e codificato da <a href="https://www.artglobal.it/" target="_blank" class="link-decoration"><u>Artglobal.it</u></a> & <a href="https://linktr.ee/rvpartap" target="_blank" class="link-decoration"><u>Rathour Vinay</u></a></p>
   		</div>
		</div>
...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <body class="container">
		...
		<div id="home-nav" class="home-navigation">
   		...
   		<img class="second-logo" src="/images/Logo/ikaros-second-logo.png" draggable="false" alt="fondazioneikaros">
   		<a href="/">Pagina Home</a>
   		<a href="/access">Accedi per ordinare</a>
   		<a href="/contact">Informazioni e contatti</a>
   		<hr>
   		<a href="https://www.fondazioneikaros.org/dona-sostieni-la-fondazione/"><i class="fa-solid fa-hand-holding-heart"></i>&#160; Sostieni la Fondazione</a>
   		<a href="https://www.fondazioneikaros.org/blog/"><i class="fa-solid fa-rss"></i>&#160; News & Blog</a>
   		...
   		<a href="https://www.istitutopolitecnico.org/" class="text-nav-fav"><img src="/images/Site-Favicons/favicon-istitutopolitecnico.png" draggable="false" alt="IstitutoPolitecnicoLogo" class="img-favicon2"> Istituto Politecnico</a>
			...
			<hr>
			<a href="/admin" target="_blank" style="font-size: 13px; color: #0088ff; width: 300px; margin-bottom: 12px;"><i class="fa-solid fa-gavel fa-lg"></i> &#160; Area riservata per gli Amministratori</a>
		</div>
		<img src="/images/svg/layered-peaks-table-up.svg" class="table-img" alt="table-up">
		<div class="main p-1">
			<h1 class="my-4 error-text"><strong>Errore:</strong></h1>
